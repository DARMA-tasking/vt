...
#if !defined INCLUDED_PIPE_CALLBACK_CALLBACK_HANDLER_SEND_H
#define INCLUDED_PIPE_CALLBACK_CALLBACK_HANDLER_SEND_H
...
#endif /*INCLUDED_PIPE_CALLBACK_CALLBACK_HANDLER_SEND_H*/
