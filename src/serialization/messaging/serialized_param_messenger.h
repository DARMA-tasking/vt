...
#if !defined __RUNTIME_TRANSPORT_SERIALIZED_MSG_PARAM__
#define __RUNTIME_TRANSPORT_SERIALIZED_MSG_PARAM__
...
#endif /*__RUNTIME_TRANSPORT_SERIALIZED_MSG_PARAM__*/
