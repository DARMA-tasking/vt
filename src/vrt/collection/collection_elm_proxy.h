...
#if !defined INCLUDED_VRT_COLLECTION_COLLECTION_ELM_PROXY_H
#define INCLUDED_VRT_COLLECTION_COLLECTION_ELM_PROXY_H
...
#endif /*INCLUDED_VRT_COLLECTION_COLLECTION_ELM_PROXY_H*/
